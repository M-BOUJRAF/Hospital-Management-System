 ...
 * @author HP
 */
public class DeleteCovids extends javax.swing.JFrame {
    ...
    public void loadData() {
        ...
        String sql = "select count,date,id,name,age,gender,address,phone,status,disease,room from covids";
        try {
    ...
    private void jLabel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel21MouseClicked
        CovidsActivity paActivity = new CovidsActivity();
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        String sql = "Delete from covids where name ='" + search + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            JOptionPane.showMessageDialog(null, "covids " + search + " has been deleted");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "covids named " + search + " not found");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteCovids.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteCovids().setVisible(true);
            }
        });
    }
