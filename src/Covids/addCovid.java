 ...
 * @author HP
 */
public class addCovid extends javax.swing.JFrame {

    /**
     * Creates new form addCovid
     */
    ...
    private void jLabel19MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel19MouseClicked
        CovidsActivity pActivity = new CovidsActivity();
    ...
    private void addDctorbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addDctorbtnMouseClicked
        ...
        if (connection != null) {
            ...
            String sql = "insert into covids(date,id,name,age,gender,address,phone,status,disease,room) values (?,?,?,?,?,?,?,?,?,?)";
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addCovid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
